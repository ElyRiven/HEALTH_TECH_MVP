...
|                        | Descripción                                                                                                                                                                                                                                                                                                                                    |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Resultado esperado** | La API valida el parámetro `patientId` antes de realizar cualquier operación sobre la base de datos. Al detectar que el valor excede el rango permitido para un entero válido, retorna una respuesta HTTP `400 Bad Request` con un mensaje descriptivo, por ejemplo: `{"message": "El parámetro patientId debe ser un número entero válido"}`. |
