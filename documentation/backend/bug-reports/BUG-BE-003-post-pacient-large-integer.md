...
|                        | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Resultado esperado** | La API valida el campo `identificacion` del body de la petición antes de realizar cualquier operación sobre la base de datos. Al detectar que el valor excede el rango permitido para un número entero de PostgreSQL (valor máximo `2147483647` para `INTEGER` o `9223372036854775807` para `BIGINT`), retorna una respuesta HTTP `400 Bad Request` con un mensaje descriptivo, por ejemplo: `{"message": "El campo identificacion debe ser un número entero válido dentro del rango permitido"}`.                                                                                                               |
