...
| R-04 | **Notificación visual no disparada (HU-009):** El componente `PatientNotificationToast.tsx` no detecta el nuevo registro correctamente |      3       |    3    | Validar el comportamiento manual primero. Incluir esperas explícitas (`waitFor`) en los scripts SerenityBDD para manejar la asincronía.   |
